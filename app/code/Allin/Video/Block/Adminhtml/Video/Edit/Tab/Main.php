...
namespace Allin\Video\Block\Adminhtml\Video\Edit\Tab;

/**
 * Video edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /* @var $model \Allin\Video\Model\BlogPosts */
        $model = $this->_coreRegistry->registry('video');
        ...
        if ($model->getId()) {
            $fieldset->addField('videos_id', 'hidden', ['name' => 'videos_id']);
        }
