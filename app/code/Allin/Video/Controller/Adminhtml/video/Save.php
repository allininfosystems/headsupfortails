...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            $model = $this->_objectManager->create('Allin\Video\Model\Video');

            $id = $this->getRequest()->getParam('videos_id');
            if ($id) {
                $model->load($id);
            ...
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath('*/*/edit', ['videos_id' => $model->getId(), '_current' => true]);
                }
            ...
            return $resultRedirect->setPath('*/*/edit', ['videos_id' => $this->getRequest()->getParam('videos_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}